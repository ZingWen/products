...
WHERE product.seller_id = $seller_id AND exist_valid = 1
                    ...
                    <div class="card mb-4">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <div class="btn-group">
                                ...
                                <a type="button" class="btn btn-warning rounded-end" href="edit_product.php?<?= filterQuery(); ?>">編輯模式</a>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <form action="product_list.php?search=<?php$search?>.php" method="GET">
                                    <div class="input-group">
                                ...
                                <form method="get" class="py-3">
                                    <div class="row g-2 align-items-center">
                                        ...
                                        <div class="col-auto">
                                            <input type="number" class="form-control text-end price-input" name="price-max" max : 99999;echo $priceMax; ?>">
                                        </div>
                                        <div class="col-auto">
                            ...
                            <table class="table">
                                <thead class="table-dark">
                                    <tr>
                                        ...
                                        <th>分級</th>
                                        <th>支援語言</th>
                                        <th>價格<a href="product_list.php?priceDown"><i class="bi bi-caret-down-fill"></i></a>
                                            <a href="product_list.php?priceUp"><i class="bi bi-caret-up-fill"></i></a>
                                        </th>
                                        <th>上架時間<a href="product_list.php?doDown"><i class="bi bi-caret-down-fill"></i></a><a href="product_list.php?doUp"><i class="bi bi-caret-up-fill"></i></a>
                                        </th>
                                        <th>商品狀態 / 資訊</th>
                                    </tr>
                                </thead>
                            ...
                            <nav class="d-flex justify-content-center">
                                ...
                                <ul class="pagination">
                                    <li class="page-item <?php echo ($page == 1) ? 'disabled' : ''; ?>">
                                        <a title="上一頁" class="page-link" href="product_list.php?page=<?php echo $page - 1; ?><?php echo filterQuery(); ?>" aria-label="Previous">
                                    ...
                                    for ($i = 1; $i <= $totalPagesToShow; $i++) : ?>
                                        <li class="page-item <?php echo ($page == $i) ? 'active' : ''; ?>">
                                            <a class="page-link" href="product_list.php?page=<?php echo $i; ?><?= filterQuery(); ?>">
                                                <?php echo $i; ?>
                                            </a>
                                        </li>
                                    <?php endfor; ?>
                                    <li class="page-item <?php echo ($page == $totalPagesToShow) ? 'disabled' : ''; ?>">
                                        <a title="下一頁" class="page-link" href="product_list.php?page=<?= $page + 1; ?><?= filterQuery(); ?>" aria-label="Next">
